...
<body>
    <header></header>
    <div class="image-box">
        <img class="image-thumbnail" src="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000087/87407/87407_320.jpg">
    </div>
        <div class="detail">
            <div class="detailposter"><img
            ...
            <div class="div2">
                ...
                <div class="content">
                    ...
                    <div class="text-wrapper">
                        <span class="text"> “완벽한 저에게 신은 저 여자를 던지셨죠” 지성과 외모 그리고 찌질함까지 타고난, '정열'(강하늘). “모기 같은 존재죠. 존재의 이유를
                            모르겠는?”능력과
                            커리어 그리고 똘기까지
                            타고난, '나라'(정소민). 영화처럼 만나 영화같은 사랑을 했지만서로의 찌질함과 똘기를 견디다 못해 마침내 완벽한 남남이 되기로 한다.그러나!완벽한 이별을 딱
                            D-30 앞둔
                            이들에게
                            찾아온 것은 줄거리끝 “완벽한 저에게 신은 저 여자를 던지셨죠” 지성과 외모 그리고 찌질함까지 타고난, '정열'(강하늘). “모기 같은 존재죠. 존재의 이유를
                            모르겠는?”능력과
                            커리어 그리고 똘기까지
                            타고난, '나라'(정소민). 영화처럼 만나 영화같은 사랑을 했지만서로의 찌질함과 똘기를 견디다 못해 마침내 완벽한 남남이 되기로 한다.그러나!완벽한 이별을 딱
                            D-30 앞둔
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 content-wrap">
                    ...
                    <form method="post">
                        <div><h2 class="review">------------------------------ review -----------------------------</h2></div>
                        <table class="table">
                            <tbody class="t-control">
                                ...
                                <tr>
                                    <td>
                                        <textarea placeholder="내용을 입력하세요." class="form-control" rows="7"
